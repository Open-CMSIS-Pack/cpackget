...
func TestDownloadFile(t *testing.T) {
	...
	t.Run("test fail to create temporary file", func(t *testing.T) {
		...
		_, err := utils.DownloadFile(goodServer.URL+"/file.txt", true, true, true, 0)
		assert.NotNil(err)
	...
	t.Run("test fail with bad http location", func(t *testing.T) {
		...
		_, err := utils.DownloadFile(fileName, true, true, true, 0)
		assert.NotNil(err)
	...
	t.Run("test fail with bad http request", func(t *testing.T) {
		...
		_, err := utils.DownloadFile(notFoundServer.URL+"/"+fileName, true, true, true, 0)
		assert.NotNil(err)
	...
	t.Run("test fail to read data stream", func(t *testing.T) {
		...
		_, err := utils.DownloadFile(bodyErrorServer.URL+"/"+fileName, true, true, true, 0)
		assert.NotNil(err)
	...
	t.Run("test download is OK", func(t *testing.T) {
		...
		_, err1 := utils.DownloadFile(url, true, true, true, 0)
		assert.Nil(err1)
