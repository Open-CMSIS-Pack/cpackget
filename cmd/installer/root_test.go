...
func removePack(t *testing.T, packPath string, withVersion, isPublic, purge bool) {
	...
	err = installer.RemovePack(shortPackPath, purge, true)
	assert.Nil(err)
...
func TestUpdatePublicIndex(t *testing.T) {
	...
	t.Run("test do not overwrite "+installer.PublicIndexName, func(t *testing.T) {
	...
	t.Run("test overwrite "+installer.PublicIndexName, func(t *testing.T) {
