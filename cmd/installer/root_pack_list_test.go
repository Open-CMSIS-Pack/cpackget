...
func ExampleListInstalledPacks_list() {
	...
	_ = installer.RemovePack("TheVendor.PublicLocalPack.1.2.3", false /*no purge*/, true)
...
func TestListInstalledPacks(t *testing.T) {
	...
	t.Run("test listing all installed packs", func(t *testing.T) {
		...
		assert.Nil(installer.RemovePack("TheVendor.PublicLocalPack.1.2.3", false /*no purge*/, true))
